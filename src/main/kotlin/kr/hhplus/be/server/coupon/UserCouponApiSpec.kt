...
interface UserCouponApiSpec {
    ...
    @Operation(
        ...
        responses = [
            ApiResponse(responseCode = "200", description = "발급 성공", content = [Content(schema = Schema(implementation = IssueCouponResponse::class))]),
    ...
    @Operation(
        ...
        responses = [
            ApiResponse(responseCode = "200", description = "조회 성공", content = [Content(schema = Schema(implementation = UserCouponListResponse::class))]),
