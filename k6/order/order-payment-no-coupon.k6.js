...
const TEST_ID = 'Order-payment-soak-test';
...
export let options = {
  ...
  duration: '10m',
  thresholds: {
    'order_create_duration': ['p(95)<1000', 'p(99.9)<2000'],
    'order_payment_duration': ['p(95)<1500', 'p(99.9)<2500'],
    'popular_order_error_rate': ['rate<0.001'],
  },
