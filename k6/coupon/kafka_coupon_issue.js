...
export const options = {
    tags: { testid: 'kafka_coupon_issue' },
    vus: 100,
    duration: '30s',
};
...
export function setup() {
    ...
    const preloadRes = http.post(`${BASE_URL}/api/v3/users/${preloadUserId}/coupons`, JSON.stringify({
        couponId: couponId
    }), { headers: { 'Content-Type': 'application/json' } });
...
export default function (data) {
    ...
    const res = http.post(`${BASE_URL}/api/v3/users/${userId}/coupons`, JSON.stringify({
